...
export class ThirdStepComponent {
  ...
  input.value = value;
  this.form.controls['Pressure'].setValue(value, { emitEvent: false });
}
  formatSugarLevel(event: Event) {
  const input = event.target as HTMLInputElement;
  ...
  input.value = value;
  this.form.controls['SugarLevel'].setValue(value, { emitEvent: false });
}
