...
export class ThirdStepComponent {
  ...
  getFoodAllergy(){
    this.spinner.show();
    this.patientService.getFoodAllergy().pipe(map((res:any)=>res['Data'])).subscribe((res:any)=>{
  ...
  getMedicineAllergy(){
    this.spinner.show();
    this.patientService.getMedicineAllergy().pipe(map((res:any)=>res['Data'])).subscribe((res:any)=>{
  ...
  getPatient(){
    this.spinner.show();
    this.service.GetPatientMedicalInfo().pipe(map((res:any)=>res['Data'])).subscribe((patient:any)=>{
  ...
  getBloodTypes(){
    this.spinner.show();
    this.service.getBloodTypes().pipe(map((res:any)=>res['Data'])).subscribe((res:any)=>{
      this.bloodTypes = res;
 ...
 formSubmit() {
  ...
  if (this.StorageService.getItem('new-user') === 'true') {
    this.service.CreatePatientProfileThirdStep(formcreate)
    ...
    this.service.UpdatePatientProfileThirdStep(form)
      .pipe(map((res: any) => res['Data']))
      .subscribe({
        next: (res: any) => {
          const eventData = this.mktService.setEventData(
  ...
  previousStep(){
    ...
    */
    // this.router.navigate([`/${this.lang}/profile/location`])
