    ...
    if (!queryParamsKeys.includes(key)){
      ...
      if(key == 'speciality'){
       ...
       // console.log(name)
        ...
        this.router.navigate([this.routesPipe.transform('find-a-doctor') + '/' + name], { queryParams: this.params }).then(() => {
        ...
        this.StorageService.setItem('search-form-specialty', JSON.stringify(object));
