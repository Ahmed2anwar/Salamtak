...
export class BookingSuccessfullyComponent {
  ...
  constructor(public dialog: MatDialog,
    ...
    this.booking = JSON.parse(this.StorageService.getItem('bookingData') || '{}') ;
  ...
  goToDoctor(doctor:any){
    this.router.navigate([this.route.transform('doctor-profile')
      ,doctor.Id,doctor.DoctorName], { queryParams: {
      DoctorId : doctor.Id,
