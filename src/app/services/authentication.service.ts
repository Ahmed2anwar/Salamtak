...
// ​/api​/{culture}​/User​/UpdatePassword
  ...
  getUnreadDoctorResponsesByUserIdAsync(){
    return this.http.get(`${environment.apiUrl}/Patient/GetUnreadDoctorResponses`)

  }
  markAllDoctorResponsesAsReadAsync(){

    return this.http.post(`${environment.apiUrl}/Patient/MarkAllDoctorResponses`, null);
  }
  getSypmptoms(specialityID:any){
    return this.http.get(`${environment.apiUrl}/Patient/GetSymptomsBySpecialityId?specialityId=${specialityID}`)

  }
  createPatientSymptoms(form:any) {
    return this.http.post<any>(`${environment.apiUrl}/Patient/CreatePatientSymptoms`, form)
  }
}
